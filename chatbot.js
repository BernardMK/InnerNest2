...
function showEmergencyContacts() {
  const emergencyInfo = `
    <strong style="color: #ef4444;">EMERGENCY RESOURCES - AVAILABLE 24/7</strong><br><br>
    ...
    • Veterans Crisis Line: <strong>1-800-273-8255</strong> (Press 1)<br>
    • Trevor Project (LGBTQ+ Youth): <strong>1-866-488-7386</strong><br>
    <br>
    <strong>🚨 Immediate Danger:</strong><br>
    • Call <strong>911</strong><br>
    • Go to nearest emergency room<br>
    <br>
    <strong>🏥 Other Support:</strong><br>
    • SAMHSA Helpline (Substance Abuse): <strong>1-800-662-4357</strong><br>
    • Domestic Violence Hotline: <strong>1-800-799-7233</strong><br>
    • NEDA (Eating Disorders): <strong>1-800-931-2237</strong><br>
    • Disaster Distress Helpline: <strong>1-800-985-5990</strong><br>
    <br>
    <strong>💬 Online Support:</strong><br>
    • NAMI (National Alliance on Mental Illness): www.nami.org<br>
    • MentalHealth.gov: www.mentalhealth.gov<br>
    • BetterHelp: www.betterhelp.com<br>
    <br>
    <strong>🌍 International:</strong><br>
    • International Association for Suicide Prevention: www.iasp.info<br>
    <br>
    Please remember: You are not alone. Help is available, and you deserve support.
  `;
  
  addMessage('assistant', emergencyInfo);
}

/* ========== Session Summary & Risk Monitoring ========== */
function getSessionSummary() {
  ...
  return {
    ...
    emotionalPatterns,
    crisisAlerts: crisisAlertCount,
    mood: currentMood
  };
}

// Auto-check session every 5 minutes for extended crisis conversations
setInterval(() => {
  if (userRiskLevel === 'critical' && messages.length > 10) {
    const lastUserMessage = messages.filter(m => m.sender === 'user').slice(-1)[0];
    const timeSinceLastMessage = Date.now() - (lastUserMessage?.timestamp || Date.now());
    
    // If no user response in 10 minutes during critical situation
    if (timeSinceLastMessage > 600000) {
      addMessage('assistant', `I haven't heard from you in a while and I'm concerned. Are you still there? If you need immediate help, please call 988 or 911.`);
    }
  }
}, 300000); // Check every 5 minutes

// Log session data (for analytics/improvement - would be sent to backend in production)
window.addEventListener('beforeunload', () => {
  const summary = getSessionSummary();
  console.log('Session Summary:', summary);
  // In production: send this to backend for analysis and improvement
});